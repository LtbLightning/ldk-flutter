...
abstract class Rust {
  ...
  FlutterRustBridgeTaskConstMeta get kLdkInitConstMeta;
}
...
class RustImpl extends FlutterRustBridgeBase<RustWire> implements Rust {
  ...
  Future<void> ldkInit(
      ...
      executeNormal(FlutterRustBridgeTask(
        callFfi: (port_) => inner.wire_ldk_init(
            port_,
            _api2wire_String(host),
            _api2wire_u16(port),
            _api2wire_String(username),
            _api2wire_String(password),
            _api2wire_String(storageDirPath),
            _api2wire_String(network)),
        parseSuccessData: _wire2api_unit,
        constMeta: kLdkInitConstMeta,
        argValues: [host, port, username, password, storageDirPath, network],
        hint: hint,
      ));
...
class RustWire implements FlutterRustBridgeWireBase {
  ...
  late final _wire_ldk_initPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64,
              ...
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>,
              ffi.Pointer<wire_uint_8_list>)>>('wire_ldk_init');
  late final _wire_ldk_init = _wire_ldk_initPtr.asFunction<
      void Function(
          int,
          ffi.Pointer<wire_uint_8_list>,
          int,
